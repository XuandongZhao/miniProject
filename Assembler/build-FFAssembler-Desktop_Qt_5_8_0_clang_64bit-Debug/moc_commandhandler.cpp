...
#include "../FFAssembler-master/Source/commandhandler.h"
...
const QMetaObject CommandHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CommandHandler.data,
      qt_meta_data_CommandHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CommandHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CommandHandler.stringdata0))
        return static_cast<void*>(const_cast< CommandHandler*>(this));
