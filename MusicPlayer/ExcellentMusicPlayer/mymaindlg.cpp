...
void MyMainDlg::searchsongui()//搜索网络歌曲界面的ui
{
   ///////////////////////////////////////////////////////////////////歌曲搜索框
    ...
    netseawidget->setGeometry(250,132,194,16);//设置动态起始的位置
...
void MyMainDlg::trayiconmenu()
{
    ...
    trayIcon->setToolTip("欢迎使用-极视听音乐播放器");
...
///////////////////////////////////////////////////////////////////////Execellentlrc文件夹下的
 ...
 if(file1.exists())//如果文件存在
 {
      ...
      {
       lrcshowedit->setAlignment(Qt::AlignHCenter);
       lrc_map.clear();//程序启动时不会擦掉极视听音乐播放器
       return;
      }
...
{
    this->showNormal();
    if(QMessageBox::Ok==QMessageBox::information(this,"关于极视听音乐播放器","本程序仅供学习使用~by yt QQ842420717,欢迎朋友交流\n"
                                                 "实现的功能有:\n"
                                                 "1.程序列表自动保存\n"
...
////////////////////////////////////////previous先前的
                ...
                formatpre.setFont(QFont("微软雅黑", 10, QFont::Thin));
                ...
                format.setFont(QFont("微软雅黑", 12, QFont::Medium));
