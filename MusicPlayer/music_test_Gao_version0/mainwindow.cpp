    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->setupUi(this);
    this->setWindowTitle("音乐播放器试用版1.2");//主界面名字
...
void MainWindow::on_Tray_clicked()
{
        ...
        mSysTrayIcon->setIcon(QIcon("/new/prefix1/image/my.ico"));
        //当鼠标移动到托盘上的图标时，会显示message
        mSysTrayIcon->setToolTip(QObject::trUtf8("test the tray icon"));
...
{
    mShowMainAction = new QAction(QObject::trUtf8("show the main window"),this);
